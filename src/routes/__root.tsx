  ...
  head: () => ({
    meta: [
      ...
      { title: "MJ Roofing & Cladding Ltd — Christchurch Roofing Specialists" },
      {
        name: "description",
        content:
          "5.0-rated Christchurch roofing & architectural cladding contractors. Re-roofs, new builds, repairs and spouting across Canterbury. Free quotes — call 022 658 0216.",
      },
      { name: "author", content: "MJ Roofing & Cladding Ltd" },
